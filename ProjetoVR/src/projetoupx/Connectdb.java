...
public class Connectdb {
    ...
    private String nomeDoBanco = "virtualroom";
    ...
    public Connectdb(String servidor, String nomeDoBanco, String usuario, String senha){
    ...
    public void conectaBanco(){
        try {
            ...
            if(conn != null){
                System.out.println("Conectado com sucesso! " + "ID: " + conn);
            }            
